...
func (r *CustomValidationRule) Validate(value interface{}) error {
	if value == "invalid_value" {
		return messaging.NewError(messaging.ErrorCodeValidation, "validation", "invalid value")
	}
	return nil
}
...
func TestValidationMiddlewareFramework(t *testing.T) {
	...
	t.Run("ValidateConfig", func(t *testing.T) {
		...
		// Should not error for valid config
	})
	...
	t.Run("ValidateMessage", func(t *testing.T) {
		...
		// Should not error for valid message
	})
	...
	t.Run("ValidateDelivery", func(t *testing.T) {
		...
		// Should not error for valid delivery
	})
